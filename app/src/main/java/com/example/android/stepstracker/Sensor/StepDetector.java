package com.example.android.stepstracker.Sensor;


import com.example.android.stepstracker.Tabs.SettingsTab;

public class StepDetector implements SettingsTab.OnSensitivityChangedListenver {

    private static final int ACCEL_RING_SIZE = 50;
    private static final int VEL_RING_SIZE = 10;

    // change this threshold according to your sensitivity preferences
    private static  int STEP_THRESHOLD = 130;
